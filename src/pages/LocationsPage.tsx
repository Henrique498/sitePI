...
import { MapPin, Phone, Mail, Search, ExternalLink, Navigation, Building2 } from 'lucide-react';
...
export function LocationsPage() {
  ...
  const mapCenter = { lat: -14.2350, lng: -51.9253 };
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-sm">Encontre a ONG mais próxima de você</p>
        </div>
      </div>
            ...
            <CardContent className="p-5">
              <div className="flex items-start gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">{ong.city}, {ong.state}</p>
                </div>
              </div>
              ...
              <div className="space-y-2 mb-4 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-muted-foreground truncate">{ong.address}</span>
                </div>
                <div className="flex items-center gap-2">
                  <Phone className="w-4 h-4 text-petgreen" />
                  <a href={`tel:${ong.phone}`} className="text-petblue hover:underline">
                    {ong.phone}
                  </a>
                </div>
                <div className="flex items-center gap-2">
                  <Mail className="w-4 h-4 text-petblue" />
                  <a href={`mailto:${ong.email}`} className="text-petblue hover:underline truncate">
                    {ong.email}
                  </a>
                </div>
              </div>
